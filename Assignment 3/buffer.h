 ...
 *Date: January 29
 *Professor: Sv. Ranev
 *Purpose: This is the file header for buffer.c
...
#define R_OK_0	0			/*returns from a function with no problems*/
#define MAX_INC_FACTOR_A 255  /*max value for inc_factor when additive mode is chosen*/
#define MAX_INC_FACTOR_M 100  /*max value for inc_value when multiplicative mode is chosen*/
#define MIN_INC_FACTOR_AM 1      /*min value for inc_factor for additive and multiplicative buffers*/
